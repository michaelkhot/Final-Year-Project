...
/**
 * Used to process the 'Time Period Performance Statistics' page of a report CSV.
 */
public class TimePeriodPerformanceStatistics implements ReportPageProcessor {
