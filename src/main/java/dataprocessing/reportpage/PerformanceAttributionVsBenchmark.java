...
/**
 * Used to process the 'Performance Attribution Vs Benchmark' page of a report CSV.
 */
public class PerformanceAttributionVsBenchmark implements ReportPageProcessor {
