...
/**
 * Used to process the 'Allocation And Performance By Sector' page of a report CSV.
 */
public class AllocationAndPerformanceBySector implements ReportPageProcessor {
